package com.skazerk.hackdex.PokeDexList.DexTabs.Info.BottomSheet
...
class BottomSheetListAdapter(context: Context, ability: String) : BaseAdapter() {
    ...
    internal val list = arrayListOf<Objects>()
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        if (position < 2) {
            ...
            val pokemon = list[position] as Abilities.PokemonSmall
    ...
    private class ListRowHolderPlain() {
        val text: TextView = R.id.simple_list_item as TextView

    }

    private class ListRowHolderPokemon() {
