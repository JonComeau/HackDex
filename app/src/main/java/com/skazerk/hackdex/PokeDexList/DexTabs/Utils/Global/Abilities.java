...
public class Abilities {
    ...
    public Abilities(Context context, String game) {
    ...
    private void loadAbilitiesFromAssets() {
        String abilityJSONStr = global.getMain().loadJSONFromAsset("games/" + game + "/abilities.json");
        String pokemonAbilityJSONStr = global.getMain().loadJSONFromAsset("games/" + game + "/pokemon_ability.json");
